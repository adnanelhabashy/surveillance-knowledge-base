...
case_number: 509
title: "Nominee Account Rotation"
...
# 509. Nominee Account Rotation

## Description

Rotating activity among nominee accounts so the same manipulation does not repeatedly appear under one account.
