...
# 463. Pump-and-Reload Cycle

## Description

Manipulators repeatedly accumulate, pump, sell, allow the price to fall, and then repeat the scheme in the same security.
