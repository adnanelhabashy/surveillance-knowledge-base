...
Placing multiple deceptive orders at several price levels to create the appearance of strong supply or demand.
...
- **Public mapping:** Nasdaq SMARTS materials explicitly describe **Layering** surveillance/capability.
