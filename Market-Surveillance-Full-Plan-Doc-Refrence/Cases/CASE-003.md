...
# 3. Wash Trading / Wash Sales

## Description

Buying and selling the same security without meaningful change in beneficial ownership to create fake activity or volume.
...
- **Public mapping:** Nasdaq SMARTS materials explicitly describe **Wash trading** surveillance/capability.
