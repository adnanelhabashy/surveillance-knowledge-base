...
case_number: 329
title: "Pegged-Order Reference Manipulation"
...
# 329. Pegged-Order Reference Manipulation

## Description

Manipulating the reference market used by pegged orders so those orders reprice in a way that benefits the manipulator.
