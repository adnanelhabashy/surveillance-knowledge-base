...
case_number: 191
title: "NBBO Join-Inducement / Disruptive Quoting"
...
# 191. NBBO Join-Inducement / Disruptive Quoting

## Description

A trader places a non-genuine order inside the best bid or offer, waits for another participant to join it, then trades against that participant from the opposite side.
