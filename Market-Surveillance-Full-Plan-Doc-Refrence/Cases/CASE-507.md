...
# 507. Multi-Venue Spoofing

## Description

Placing deceptive orders across several venues so the combined false pressure is not visible in a single venue's data.
