...
A customer order or execution is deliberately split into many smaller trades primarily to maximize market-data payments, rebates, or similar compensation.
