...
# 414. RFQ Front Running

## Description

Trading before or around a customer request-for-quote using confidential knowledge of the customer's intended transaction.
...
- **Public mapping:** Nasdaq SMARTS materials explicitly describe **RFQ front running** surveillance/capability.
