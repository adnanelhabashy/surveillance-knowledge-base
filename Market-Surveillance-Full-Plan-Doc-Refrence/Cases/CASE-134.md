...
A trader posts attractive orders to lure slower traders, then rapidly changes those orders to worse terms in an attempt to trade profitably against incoming flow.
